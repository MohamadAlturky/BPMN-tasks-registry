...
agent = Agent(
    ...
    goal="Extract activities from the given process description '{process_description}' and organize them for BPMN diagram generation.",
    backstory="As a business process analyst, you analyze process descriptions to extract and organize activities needed for creating BPMN diagrams.",
...
task = Task(
    description=(
        ...
        "Each activity should represent a distinct step in the process. "
        "List each activity in the order it occurs, ensuring each activity is clearly described and sequenced appropriately."
    ),
    expected_output=(
        "A structured list of activities with their respective sequences, formatted for BPMN diagram creation."
    ),
